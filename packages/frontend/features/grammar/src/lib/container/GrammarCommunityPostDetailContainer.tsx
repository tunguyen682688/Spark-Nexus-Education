...
export function GrammarCommunityPostDetailContainer({
  ...
  if (!post) {
    return (
      <div className="flex flex-col h-screen items-center justify-center bg-[#03050d] text-slate-400 gap-4">
  ...
  return (
    <div className="w-full max-w-full mx-auto p-4 sm:p-6 lg:p-8 space-y-6 min-h-screen bg-[#03050d]">
      {/* Header */}
      ...
      <div className="space-y-6 pt-6">
        <h3 className="text-xl font-bold text-slate-200">
          {GRAMMAR_UI_TEXT.communityPostDetail.commentsTitle.replace('{count}', String(post.comments?.length || 0))}
        </h3>
