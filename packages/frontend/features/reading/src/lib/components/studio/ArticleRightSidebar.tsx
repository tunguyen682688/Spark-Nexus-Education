...
import { Calendar, Settings2, BookOpen } from 'lucide-react';
            ...
            <AccordionContent>
              <div className="pb-2 space-y-3">
                ...
                <div className="text-[10px] text-slate-400 dark:text-slate-500 italic pl-1">
                  Mặc định hệ thống tự động tạo một bộ từ vựng riêng cho bài viết. Bạn có thể chọn liên kết với bộ từ vựng có sẵn của mình.
                </div>
