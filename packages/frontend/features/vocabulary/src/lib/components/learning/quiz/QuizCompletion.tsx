      ...
      <div className="flex flex-col items-center max-w-lg w-full text-center z-10 gap-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-slate-400">
            Bạn đã làm rất tốt. Hãy tiếp tục duy trì nhé!
          </p>
        </div>
        ...
        <div className="relative flex items-center justify-center w-36 h-36">
          ...
          <div className="absolute flex flex-col items-center justify-center">
            ...
            <span className="text-[10px] uppercase font-bold text-slate-500 tracking-wider">Độ chính xác</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-4 gap-3 w-full bg-slate-900/40 border border-slate-800/80 rounded-xl p-4 text-left">
          <div className="flex flex-col items-center justify-center p-2 rounded-lg bg-slate-900/50">
            <span className="text-slate-500 text-[10px] font-bold uppercase tracking-wider mb-1 flex items-center gap-1">
              <Clock className="w-3 h-3 text-blue-400" /> Thời Gian
            </span>
          ...
          <div className="flex flex-col items-center justify-center p-2 rounded-lg bg-slate-900/50">
            <span className="text-slate-500 text-[10px] font-bold uppercase tracking-wider mb-1 flex items-center gap-1">
              <AlertCircle className="w-3 h-3 text-emerald-400" /> Câu Đúng
            </span>
          ...
          <div className="flex flex-col items-center justify-center p-2 rounded-lg bg-slate-900/50">
            <span className="text-slate-500 text-[10px] font-bold uppercase tracking-wider mb-1 flex items-center gap-1">
              <BookOpen className="w-3 h-3 text-purple-400" /> Từ Mới
            </span>
        ...
        <div className="w-full text-left bg-slate-900/40 border border-slate-800/80 rounded-xl p-4 flex flex-col gap-3">
          <span className="text-sm font-semibold text-slate-300 flex items-center gap-2">
            <TrendingUp className="w-4 h-4 text-blue-500" /> Phân tích mức độ thành thạo
          </span>
          <div className="flex flex-col gap-2.5">
            <div>
              <div className="flex justify-between text-xs mb-1">
                <span className="text-slate-400">ĐỘ CHÍNH XÁC PHIÊN HỌC</span>
        ...
        {failedQuestionsList.length > 0 && (
          <div className="w-full text-left bg-emerald-950/10 border border-emerald-500/20 rounded-xl p-4 flex flex-col gap-3">
            <span className="text-sm font-semibold text-emerald-400 flex items-center gap-2">
              ...
              Từ vựng đã sửa sai thành công ({failedQuestionsList.length} từ)
            </span>
            ...
            {onRestartFailedQuestions && (
              ...
              >
                <RotateCcw className="w-3.5 h-3.5" /> Luyện tập lại {failedQuestionsList.length} câu đã từng làm sai
              </button>
            )}
          </div>
        )}
        ...
        <div className="w-full text-left flex flex-col gap-3">
          <span className="text-sm font-semibold text-slate-300"><span role="img" aria-label="Lightbulb">💡</span> Gợi ý học tập</span>
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div className="flex flex-col text-left">
                ...
                <span className="text-[10px] text-slate-500">Thử thách từ nghĩa khó</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-4 w-full pt-2">
          ...
          >
            <RotateCcw className="w-5 h-5" /> Tiếp tục luyện tập
          </button>
        </div>
      </div>
    </div>
