...
import { usePurchasedCollectionsContainerLogic } from '../hooks/usePurchasedCollectionsContainerLogic';
import { PurchasedCollectionCard } from '../components/PurchasedCollectionCard';
import { LoadingSkeleton } from '../components/LoadingSkeleton';
import { ErrorState } from '../components/ErrorState';
import { CERTIFICATION_UI_TEXT } from '../constants/certification.constants';

export const CertificationPurchasedCollectionsContainer: React.FC = () => {
  const {
    isApiLoading,
    isError,
    refetch,
