...
const TOP_EDITORIAL_BADGES: EditorialBadgeItem[] = [
  { title: CERTIFICATION_UI_TEXT.editorialPicks.badges.expertCurated, desc: CERTIFICATION_UI_TEXT.editorialPicks.badges.expertCuratedDesc, color: 'text-indigo-600 bg-indigo-50 dark:bg-indigo-950/20' },
  { title: CERTIFICATION_UI_TEXT.editorialPicks.badges.qualityAssured, desc: CERTIFICATION_UI_TEXT.editorialPicks.badges.qualityAssuredDesc, color: 'text-purple-600 bg-purple-50 dark:bg-purple-950/20' },
  { title: CERTIFICATION_UI_TEXT.editorialPicks.badges.provenEffective, desc: CERTIFICATION_UI_TEXT.editorialPicks.badges.provenEffectiveDesc, color: 'text-emerald-600 bg-emerald-50 dark:bg-emerald-950/20' },
  { title: CERTIFICATION_UI_TEXT.editorialPicks.badges.bestValue, desc: CERTIFICATION_UI_TEXT.editorialPicks.badges.bestValueDesc, color: 'text-amber-500 bg-amber-50 dark:bg-amber-950/20' },
];
...
export function useEditorialPicksContainerLogic() {
  ...
  const {
    ...
    error,
    refetch,
  } = useFeaturedCollections(selectedExamCategory === 'All Exams' ? undefined : selectedExamCategory);
  ...
  return {
    ...
    error,
    refetch,
    topEditorialBadges: TOP_EDITORIAL_BADGES,
