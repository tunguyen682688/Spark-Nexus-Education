...
export function useTrendingContainerLogic(
  ...
  const whyTrendingReasons: WhyTrendingReason[] = [
    {
      title: CERTIFICATION_UI_TEXT.trending.reasons.highCompletion,
      desc: CERTIFICATION_UI_TEXT.trending.reasons.highCompletionDesc,
      color: 'text-emerald-500 bg-emerald-50 dark:bg-emerald-950/20',
    },
    {
      title: CERTIFICATION_UI_TEXT.trending.reasons.popularLearners,
      desc: CERTIFICATION_UI_TEXT.trending.reasons.popularLearnersDesc,
      color: 'text-blue-500 bg-blue-50 dark:bg-blue-950/20',
    },
    {
      title: CERTIFICATION_UI_TEXT.trending.reasons.topRated,
      desc: CERTIFICATION_UI_TEXT.trending.reasons.topRatedDesc,
      color: 'text-amber-500 bg-amber-50 dark:bg-amber-950/20',
    },
    {
      title: CERTIFICATION_UI_TEXT.trending.reasons.examAligned,
      desc: CERTIFICATION_UI_TEXT.trending.reasons.examAlignedDesc,
