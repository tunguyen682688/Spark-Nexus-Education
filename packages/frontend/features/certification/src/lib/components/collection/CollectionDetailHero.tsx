...
import { CollectionViewModel, formatField } from '../../hooks/container-logic/collection/use-collection-detail-container-logic';
        ...
        <div className="flex items-center gap-3">
          ...
          {isOwner && onEditCollection && (
            <Button
              ...
              className="bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs py-2 px-4 rounded-xl shadow-sm flex items-center gap-1.5 cursor-pointer"
            >
              Edit Collection
            </Button>
          )}
