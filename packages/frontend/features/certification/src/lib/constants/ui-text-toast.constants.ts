export const TOAST_UI_TEXT = {
  sessionStarted: {
    title: 'Bắt đầu bài thi',
    description: 'Phiên thi của bạn đã bắt đầu. Chúc bạn hoàn thành tốt bài thi!',
  },
  answerSaved: {
    title: 'Đã lưu đáp án',
  ...
  violationRecorded: {
    ...
    description: 'Hệ thống phát hiện hành vi chuyển màn hình hoặc thoát cửa sổ thi.',
  },
  sessionSubmitted: {
    title: 'Nộp bài thành công',
    description: 'Bài thi của bạn đã được chấm điểm và phân tích năng lực bởi AI.',
  },
  errorOccurred: {
